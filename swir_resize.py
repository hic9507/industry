...
args = {
    ...
    "graphs_folder": "D:/waper/resize/graph/",
    "model_save_folder": "D:/waper/resize/trained_model/",
    "epoch": 50,
    "batch_size": 4,
    "learning_rate": 1e-4,
    "img_size": (256, 256),
...
##### 모델 로드
base_model = ResNet50(weights='imagenet', include_top=True, input_tensor=Input(shape=(256, 256, 3)))      # 원본 이미지
