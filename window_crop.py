...
# 기본 설정
args = {
    "data_folder": "D:/plastic/crop/data/",
    "graphs_folder": "D:/plastic/crop/graph/",
    "model_save_folder": "D:/plastic/crop/trained_model/",
    "epoch": 50,
    "batch_size": 4,
    "learning_rate": 1e-4,
    "img_size": (300, 300),
...
##### 모델 로드
base_model = ResNet50(weights='imagenet', include_top=True, input_tensor=Input(shape=(300, 300, 3)))      # 3x3 이미지
