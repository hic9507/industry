...
args = {
    ...
    "graphs_folder": "D:/plastic/original/graph/",
    "model_save_folder": "D:/plastic/original/trained_model/",
    "epoch": 50,
    "batch_size": 1,
    "learning_rate": 1e-4,
    "img_size": (2056, 2464),
...
##### 모델 로드
base_model = ResNet50(weights='imagenet', include_top=True, input_tensor=Input(shape=(2464, 2056, 3)))      # 원본 이미지
